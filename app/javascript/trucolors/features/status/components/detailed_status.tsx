...
import EditedTimestamp from 'truecolors/components/edited_timestamp';
...
import type { StatusLike } from 'truecolors/components/hashtag_bar';
import { getHashtagBarForStatus } from 'truecolors/components/hashtag_bar';
