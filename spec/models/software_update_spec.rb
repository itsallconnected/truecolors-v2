...
RSpec.describe SoftwareUpdate do
  ...
  describe '#pending?' do
    ...
    before { allow(Truecolors::Version).to receive(:gem_version).and_return(Gem::Version.new(truecolors_version)) }

    context 'when the runtime version is older than the update' do
      let(:truecolors_version) { '4.0.0' }
  ...
  describe '.pending_to_a' do
    before do
      allow(Truecolors::Version).to receive(:gem_version).and_return(Gem::Version.new(truecolors_version))
    ...
    context 'when the Truecolors version is an outdated release' do
      let(:truecolors_version) { '3.4.0' }
    ...
    context 'when the Truecolors version is more recent than anything last returned by the server' do
      let(:truecolors_version) { '5.0.0' }
    ...
    context 'when the Truecolors version is an outdated nightly' do
      let(:truecolors_version) { '4.3.0-nightly.2023-09-10' }
    ...
    context 'when the Truecolors version is a very outdated nightly' do
      let(:truecolors_version) { '4.2.0-nightly.2023-07-10' }
    ...
    context 'when the Truecolors version is an outdated dev version' do
      let(:truecolors_version) { '4.3.0-0.dev.0' }
    ...
    context 'when the Truecolors version is an outdated beta version' do
      let(:truecolors_version) { '4.3.0-beta1' }
    ...
    context 'when the Truecolors version is an outdated beta version and there is a rc' do
      let(:truecolors_version) { '4.3.0-beta1' }
